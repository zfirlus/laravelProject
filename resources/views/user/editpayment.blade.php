        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div style="">
                        <button type="submit" onClick="location.href = '{{ url('payment',$payment->expenses_id) }}'" class="btn btn-primary" style="position:absolute; margin-left:67%; margin-top:-6%;">Anuluj</button>
                    </div>
